...
static const wchar_t supported_version[] = STR("Version:2025/05/21 Revision:65821");
...
bool check_game_version()
{
	...
	wcscpy_s(game_version, sizeof(game_version), (wchar_t *)((char *)module_info.lpBaseOfDll + 0x04718660));
