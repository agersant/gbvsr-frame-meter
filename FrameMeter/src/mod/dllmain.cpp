...
static const wchar_t supported_version[] = STR("Version:2024/01/11 Revision:39743");
...
bool check_game_version()
{
	...
	wcscpy_s(game_version, sizeof(game_version), (wchar_t *)((char *)module_info.lpBaseOfDll + 0x456DCB0));
